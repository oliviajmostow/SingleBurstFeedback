...
def main():
	time = 127
	colors = ['mediumblue', 'dodgerblue', 'lightskyblue', 'pink', 'red']
	labels = ['z=10','z=8','z=6','z=4','z=2']
	num_bins = 50
	runs= ['../mag4_red10_hr/sb_mass8-output','../mag4_red8_hr/sb_mass8-output', '../mag4_red6_hr/sb_mass8-output', '../mag4_red4_hr/sb_mass8-output', '../mag4_red2_hr/sb_mass8-output']
